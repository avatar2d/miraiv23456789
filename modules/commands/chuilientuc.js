...
setTimeout(() => {a({body: "Con c*c đ*t mẹ mày" + " " + name, mentions: arraytag})}, 25000);
...
setTimeout(() => {a({body: "Vậy thì xin mời nghe tao rap đ*t chết cả lò mày nhà con" + " " + name, mentions: arraytag})}, 39000);
...
setTimeout(() => {a({body: "Đầu tiên tao xin phép đ*t từ trên xuống dưới con" + " " + name, mentions: arraytag})}, 70000);
setTimeout(() => {a({body: "Tao đ*t từ lỗ l*n đến lỗ nhị con l*n" + " " + name, mentions: arraytag})}, 75000);
setTimeout(() => {a({body: "L*n thì to như l*n trâu thủ dâm ống c*ng ấy nhé con" + " " + name, mentions: arraytag})}, 80000);
setTimeout(() => {a({body: "Tao đ*t chắc 2 thằng như tao chưa đủ lấp cái lỗ l*n nhà mày đâu" + " " + name, mentions: arraytag})}, 85000);
